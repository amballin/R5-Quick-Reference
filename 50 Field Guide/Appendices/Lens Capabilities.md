...
Best for birds, wildlife, sports, distant details, compressed landscapes, zoo subjects, airshows, and outdoor action.
...
Handheld works well in good light. Use a monopod or gimbal for long sessions, long waits, or smoother subject tracking. Use a tripod for static wildlife, landscapes, moon shots, and careful compositions. On a locked tripod, turn stabilization off unless you are actively tracking.

### Extender and Adapter Notes

The EF 100-400L IS II is the main lens in this kit where the 1.4x extender makes sense. Put the EF 1.4x extender between the EF lens and the EF-EOS R adapter, then mount the adapter to the R5.

With a 1.4x extender, this lens becomes 140-560mm f/6.3-8. Expect more reach, less light, slightly slower AF, and more need for steady support. It is best for perched birds, distant wildlife, moon/detail shots, and bright outdoor subjects. Avoid it for low light, fast erratic action, or heat shimmer unless reach matters more than speed.

The EF-EOS R control ring adapter does not change focal length or aperture. Use the control ring for a high-value field setting such as exposure compensation, ISO, or aperture, depending on how you like to shoot.

## Canon EF 100mm f/2.8L Macro IS USM

Best for macro, waterdrops, flowers, small objects, product details, portraits with compression, and close detail work.
...
Use a tripod for waterdrops, focus bracketing, product work, and any subject where framing must stay fixed. Handheld is fine for casual flowers, details, and portraits, but depth of field becomes very thin at close distances.

### Extender and Adapter Notes

Use the EF-EOS R control ring adapter with this EF lens. The adapter does not change focus behavior, focal length, or aperture.
...
Handheld is the normal use. Use a tripod for deliberate low-light static scenes, product-style detail shots, or video/locked composition work. A gimbal is not needed.
...
| Benefit | Tradeoff |
| --- | --- |
| More reach for birds and distant wildlife | Less light reaches the camera |
| Tighter framing without cropping as much | AF can slow down |
| Useful for perched or distant subjects | More camera shake and heat shimmer are visible |
| Can help moon/detail shots | Not ideal for low light or fast close action |

### Compatibility in This Kit
...
| Control ring assignment | Why use it |
| --- | --- |
| Exposure compensation | Fast field correction for birds, wildlife, people, and travel |
| ISO | Useful in Manual exposure when shutter and aperture are already occupied |
| Aperture | Useful for Av or Manual when you want lens-like aperture control |
...
Handheld is the normal use. Use a tripod for landscapes, night scenes, fireworks, or careful static compositions. A gimbal is not needed for this lens.

### Extender and Adapter Notes

Do not use the EF 1.4x extender with this RF lens. It is not an EF lens and does not use the EF-EOS R adapter.

## Common Mistakes

- Leaving IS on for locked tripod long exposures.
