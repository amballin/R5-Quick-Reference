...
AF-ON is the intelligent-acquisition AF-start button. Its approved INFO details maintain the active profile or DOF-selected AF Operation, temporarily select Face + Tracking, and maintain Servo AF characteristics. This detail remains pending physical camera verification.
...
This arrangement preserves the baseline-plus-overrides architecture: the profile determines the shooting environment and initial AF Operation, while the two rear buttons consistently select tracking or precision.
