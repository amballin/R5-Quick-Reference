...
The editor runs only on this Mac. It never publishes the website. Git commit and push are available only inside the guarded **Finish Day** workspace, with an exact source review and separate confirmations.
