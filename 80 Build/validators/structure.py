...
REQUIRED_FILES = [
    ...
    "80 Build/camera_control/guarded_run.py",
    "80 Build/camera_control/physical_write_policy.py",
    "80 Build/camera_control/session_journal.py",
    "80 Build/camera_control/write_qualification.py",
    ...
    "80 Build/validators/profile_catalog_policy_validator.py",
    "80 Build/validators/codeowners_validator.py",
    ...
    "80 Build/test_profile_pack.py",
    "80 Build/test_profile_pack_build.py",
    "80 Build/test_profile_pack_editor.py",
    "80 Build/test_profile_pack_selection.py",
    "80 Build/test_profile_pack_validator.py",
    "80 Build/test_profile_catalog_policy.py",
    "80 Build/test_codeowners_validator.py",
    "80 Build/test_control_reference.py",
    "80 Build/test_control_validator.py",
    "80 Build/test_feature_interactions.py",
    "80 Build/test_lens_guidance.py",
    ...
    "80 Build/validators/feature_interaction_validator.py",
    "80 Build/validators/lens_guidance_validator.py",
    "80 Build/validators/camera_guarded_run_validator.py",
    "80 Build/workflow_guides.py",
    "Start Camera Lab.command",
    "Start Profile Editor.command",
    "Stop Profile Editor.command",
    "WORKFLOWS/index.md",
    "WORKFLOWS/application-owner-protection.md",
