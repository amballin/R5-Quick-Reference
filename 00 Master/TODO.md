...
Camera Lab evidence promotion is now available through Profile Editor for exact C1–C3 configured-setting evidence from completed physical EDSDK sessions. Broader checklist, read-back, registration, operational-test, backup, Canon-capability, and owner-confirmed evidence promotion remains deliberately manual unless a later evidence-specific need justifies another reviewed mapping.
